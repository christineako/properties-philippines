...
$htmltbname = "b_listing";
$htmlpage = "listing.php";

?>
<!DOCTYPE html>
<html>
<head>
	<?php echo cfg::get('ListingHTML');?>
												...
												<div class="row px-4">
													<div class="col-sm-6">
															...
															<div class="form-floating mb-3">
																<select class="form-select" id="A_a" aria-label="">
																	<?php echo opt_propertytype("","Choose");?>
																</select>
																<label for="A_a">Property Type Code</label>
															</div>
															<div class="form-floating mb-3">
																<select class="form-select" id="A_b" aria-label="" disabled="">
																	<?php //echo opt_propertyclass("","Choose");?>
																</select>
																<label for="A_b">Property Class Code</label>
															</div>
															<div class="form-floating mb-3">
																<input type="text" class="form-control" id="A_c" placeholder="Listing Name">
																<label for="A_c">Listing Name</label>
															</div>
															<div class="form-floating mb-3">
																<textarea class="form-control" placeholder="Listing Description" id="A_d" style="height: 200px"></textarea>
																<label for="A_d">Listing Description</label>
															</div>
															<div class="form-floating mb-3">
																<select class="form-select" id="A_e" aria-label="">
																	<?php echo opt_locationcity("","Choose");?>
																</select>
																<label for="A_e">Property Location Code</label>
															</div>
															<div class="form-floating mb-3">
																<input type="text" class="form-control" id="A_f" placeholder="Proprety Address">
																<label for="A_f">Proprety Address</label>
															</div>
															<div class="form-floating mb-3">
																<input type="text" class="form-control" id="A_g" placeholder="Building Name">
																<label for="A_g">Building Name (optional)</label>
															</div>
								...
								<div class="d-flex flex-lg-row flex-column justify-content-center">
										<div class="">
											<div class="form-floating m-1">
												<select class="form-select" id="B_a" aria-label="Property Code">
													<?php echo opt_propertytype();?>
												</select>
												<label for="B_a">Property Code</label>
											</div>
										</div>
										<div class="">
											<div class="form-floating m-1">
												<select class="form-select" id="B_b" aria-label="Property Class">
													<?php echo opt_propertyclass();?>
												</select>
												<label for="B_b">Property Class</label>
											</div>
										</div>
										<div class="">
											<div class="form-floating m-1">
												<select class="form-select" id="B_c" aria-label="Location">
													<?php echo opt_locationcity();?>
												</select>
												<label for="B_c">Location</label>
											</div>
										</div>
